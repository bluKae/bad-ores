...
public class BadOreShovelItem extends ShovelItem {
    private final OreTemplate template;

    public BadOreShovelItem(OreTemplate template, ToolMaterial material, float attackDamage, float attackSpeed,
