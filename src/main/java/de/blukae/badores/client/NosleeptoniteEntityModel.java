...
public class NosleeptoniteEntityModel extends EntityModel<LivingEntityRenderState> {
    ...
    private final ModelPart bottom = root.getChild("bottom");
    private final ModelPart top = root.getChild("top");
    private final ModelPart mouthbottom = root.getChild("mouthbottom");
    private final ModelPart mouthtop = root.getChild("mouthtop");
    private final ModelPart teethbottom1 = root.getChild("teethbottom1");
    private final ModelPart teethbottom2 = root.getChild("teethbottom2");
    private final ModelPart teethbottom3 = root.getChild("teethbottom3");
    private final ModelPart teethtop1 = root.getChild("teethtop1");
    private final ModelPart teethtop2 = root.getChild("teethtop2");
    private final ModelPart teethtop3 = root.getChild("teethtop3");
