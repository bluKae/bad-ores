...
class BadOreShovelItem(val ore: BadOre, material: ToolMaterial, attackDamage: Float, attackSpeed: Float, properties: Properties) : ShovelItem(material, attackDamage, attackSpeed, properties) {
